...
import com.thucphan.calendar.manager.Day;
import com.thucphan.calendar.manager.Formatter;
import com.thucphan.calendar.manager.Month;
import com.thucphan.calendar.manager.Week;
import com.thucphan.calendar.widget.DayView;
import com.thucphan.calendar.widget.IndicatorView;
import com.thucphan.calendar.widget.WeekView;
...
//        return mResizeManager.onTouchEvent(event);
    ...
    private void populateDays() {
        ...
        if (!initialized) {
            ...
            if (manager != null) {
                ...
                Week week = (Week) manager.getUnits();
    ...
    private void validateIndicator() {
        LinearLayout indicator = (LinearLayout) findViewById(R.id.indicators);
        IndicatorView layout = (IndicatorView) indicator.getChildAt(0);
        int childCount = layout.getChildCount();
        Week week = (Week) mManager.getUnits();
        List<Day> days = week.getDays();
        for (int i = 0; i < childCount; i++) {
            TextView textView = (TextView) layout.getChildAt(i);
            Day day = days.get(i);
            textView.setVisibility(day.isToday() ? View.VISIBLE : View.GONE);
        }
    }
